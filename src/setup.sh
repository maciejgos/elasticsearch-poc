...
(echo -n '{"filename":zbiorczyWydrukZa_grudzien_2020 (1).pdf", "data": "'; base64 ./"data/zbiorczyWydrukZa_grudzien_2020 (1).pdf"; echo '"}') | curl -H "Content-Type: application/json" -d @-  http://localhost:9200/documents/_doc/2?pipeline=documents
